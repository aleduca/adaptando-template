                    ...
                    <div class="woocommerce">
                        <form method="post" action="#">
                            <table cellspacing="0" class="shop_table cart">
                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-quantity">
                                            <div class="quantity buttons_added">
                                                ...
                                                <input type="text" size="4" id="qty<?php echo $product['id']; ?>" class="input-text qty text" value="<?php echo $product['qty'] ?>" title="Qty" value="1" min="0" step="1">
                                ...
                                <tr>
                                    <td colspan="6"><a href="?inc=clear-cart">Clear</a></td>
                                </tr>
                            </table>
                        </form>
